...
const customShadows = (mode: SystemMode): Theme['customShadows'] => {
  return {
    ...
    blue: {
      sm: '0px 2px 6px rgb(var(--mui-palette-blue-mainChannel) / 0.3)',
      md: '0px 4px 16px rgb(var(--mui-palette-blue-mainChannel) / 0.4)',
      lg: '0px 6px 20px rgb(var(--mui-palette-blue-mainChannel) / 0.5)'
    },
    secondary: {
