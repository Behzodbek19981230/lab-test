    ...
    light: {
      palette: {
        blue: {
          ...
          light: '#6ec8f5',
          dark: '#0a8ac4',
          lighterOpacity: 'rgb(var(--mui-palette-blue-mainChannel) / 0.08)',
          lightOpacity: 'rgb(var(--mui-palette-blue-mainChannel) / 0.16)',
          mainOpacity: 'rgb(var(--mui-palette-blue-mainChannel) / 0.24)',
          darkOpacity: 'rgb(var(--mui-palette-blue-mainChannel) / 0.32)',
          darkerOpacity: 'rgb(var(--mui-palette-blue-mainChannel) / 0.38)'
        },
        primary: {
          main: '#04307b',
          light: '#3f51b5',
