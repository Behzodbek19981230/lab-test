...
const InvalidProductsList = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('name', {
        header: () => <Typography>SO ariza raqami</Typography>,
      ...
      columnHelper.accessor('address', {
        header: () => <Typography className='w-72'>Mahsulot egasi</Typography>,
        cell: () => (
      ...
      columnHelper.accessor('companyEmail', {
        header: () => <Typography>Mahsulot nomi</Typography>,
  ...
  return (
    <Card>
      <CardHeader title='Yaroqsiz deb topilgan sinov natijalarini qayd etish' />
...
export default InvalidProductsList
