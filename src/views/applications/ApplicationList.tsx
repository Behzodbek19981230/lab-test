...
const ApplicationListTable = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('contact', {
        ...
        cell: ({ row }) => (
          <Chip
            ...
            variant='tonal'
            label={row.original.warning}
            size='small'
            color={row.original?.warning ? chipColor[row.original?.warning]?.color : 'secondary'}
          />
        )
      }),

      columnHelper.accessor('total', {
        header: () => <Typography className='text-wrap max-w-[100px]'>Ariza raqami</Typography>,
      ...
      columnHelper.accessor('balance', {
        ...
        cell: () => <Typography color='text.primary'>SK-1237543/1-22</Typography>
      }),
