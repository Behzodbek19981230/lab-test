...
export const chipColor: { [key: string]: chipColorType } = {
  ...
  'Sinov kechikmoqda': { color: 'warning' },
  Bajarilgan: { color: 'success' }
}
      ...
      columnHelper.accessor('invoiceStatus', {
        ...
        cell: ({ row }) => (
          <Chip
            ...
            variant='tonal'
            label={row.original.accepted}
            size='small'
            color={row.original?.accepted ? chipColor[row.original?.accepted]?.color : 'secondary'}
          />
        )
      }),
      ...
      columnHelper.accessor('action', {
        ...
        cell: ({ row }) => (
          <div className='flex items-center'>
            <IconButton>
              <Link href={getLocalizedUrl(`/applications/show/${row.original.id}`, locale as Locale)} className='flex'>
            ...
            <OptionMenu
              ...
              options={[
                {
                  text: 'Bayonnoma shakllantirish',
                  href: getLocalizedUrl(`/protocol/create/${row.original.id}`, locale as Locale),
    ...
    <Card>
      <CardContent className='flex justify-between flex-col items-start md:items-center md:flex-row gap-4'>
        <div className='flex items-center justify-between gap-4'>
          <Typography variant='h4'>{dictionary['acceptedApplication']} </Typography>
