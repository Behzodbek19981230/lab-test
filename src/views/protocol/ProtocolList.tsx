...
const ProtocolListTable = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('company', {
        header: 'Maxsulot egasi',
        cell: () => <Typography>FIO </Typography>
      }),
      columnHelper.accessor('dueDate', {
        header: 'Maxsulot nomi',
        cell: () => <Typography>Mahsulot </Typography>
      }),

      columnHelper.accessor('total', {
        header: () => <Typography className='text-wrap max-w-[100px]'>Sinov natijasi</Typography>,

        cell: () => <Typography>Yaroqli</Typography>
      }),

      // columnHelper.accessor('issuedDate', {
      //   header: 'Izoh',
      //   cell: ({ row }) => <Typography>Ijroga qabul qilindi</Typography>
      // }),
      columnHelper.accessor('balance', {
        header: 'Izoh',
        cell: () => <Typography color='text.primary'></Typography>
      }),
...
export default ProtocolListTable
