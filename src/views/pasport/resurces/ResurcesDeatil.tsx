...
import ResurcesTable from '@/views/pasport/resurces/ResurcesTable'

export default function ResurcesDetail() {
  return (
    <Card>
      <CardContent>
        <Grid container className='mb-3'>
          ...
          >
            <h3 className='text-lg font-bold '>Resurslar mavjudligi haqida ma’lumot</h3>
          </Grid>
