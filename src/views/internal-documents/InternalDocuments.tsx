...
const InternalDocList = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('companyEmail', {
        ...
        cell: () => <Typography>123 500 000.00</Typography>
      }),
    ...
    <>
      <div className='flex justify-end items-center p-4 mb-4'>
        <div className='flex items-center'>
          <Link href={getLocalizedUrl('/application/create', locale as Locale)}>
...
export default InternalDocList
