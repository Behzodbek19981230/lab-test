...
const EventsList = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('balance', {
        header: () => (
          <Typography className='text-wrap max-w-96'>
            Aniqlangan xolislikka xavf soluvchi holatlarni bartaraf etish bo`yicha amalga oshirilgan chora tadbirlar
          </Typography>
        ),
      ...
      columnHelper.accessor('name', {
        header: () => <Typography className='w-[40%]'>Izoh</Typography>,
        cell: () => <Typography className='w-[40%]'></Typography>
      }),
  ...
  return (
    <Card>
      <CardHeader title='Xolislikka xavf soluvchi holatlarni bartaraf etish bo`yicha amalga oshirilgan chora tadbirlarni qayt etish' />
