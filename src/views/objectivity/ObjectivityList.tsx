...
const ObjectivityList = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('name', {
        header: 'Xavf manbasi va kelib chiqish sabablari',
        cell: () => <Typography> </Typography>
      }),
      columnHelper.accessor('company', {
        header: 'Xavf bilan to`qnashgan xodim',
        cell: ({ row }) => (
  ...
  return (
    <Card>
      <CardHeader title='Xolislikka xavf soluvchi holatlar' />
...
export default ObjectivityList
