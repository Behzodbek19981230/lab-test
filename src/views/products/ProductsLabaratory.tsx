  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('company', {
        header: () => <Typography className='text-wrap max-w-[100px]'>Saqlash talabi</Typography>,

        cell: () => <Typography>Normal</Typography>
      }),
      columnHelper.accessor('total', {
        header: () => <Typography className='text-wrap max-w-[100px]'>Qo`shimcha qismlar</Typography>,

        cell: () => <Typography>Mavjud emas</Typography>
      }),
      ...
      columnHelper.accessor('avatar', {
        header: () => <Typography className='text-wrap max-w-[100px]'>Mahsulotni labaratoriyadagi holati</Typography>,
        cell: () => (
          <div className='flex items-center gap-3'>
            <div className='flex flex-col'>
              <Typography className='font-medium' color='text.primary'>
                Sinovgacha saqlash holatida
              </Typography>
            </div>
          </div>
        )
    ...
    <Card>
      <CardContent className='flex justify-between flex-col items-start md:items-center md:flex-row gap-4'>
        <div className='flex items-center justify-between gap-4'>
          <Typography variant='h4'>{dictionary['workAcceptedForTestProducts']} </Typography>
                  ...
                  return (
                    <tr
                      ...
                      className={classnames(
                        ...
                        row.original.id % 3 == 0 ? 'bg-errorLight' : 'bg-successLight'
                      )}
                    >
...
export default ProductsLabaratoryTable
