...
const IncomingComplaintsList = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('address', {
        header: () => <Typography className='w-72'>Shikoyat egasi</Typography>,
        cell: ({ row }) => (
      ...
      columnHelper.accessor('name', {
        header: () => <Typography>Shikoyat xati raqami</Typography>,
        cell: () => <Typography>21-08/SH-IN </Typography>
      }),
      columnHelper.accessor('companyEmail', {
        header: () => <Typography>Sanasi</Typography>,
        cell: () => <Typography>20.08.2024 </Typography>
      }),
      ...
      columnHelper.accessor('dueDate', {
        header: () => <Typography>Izoh</Typography>,
  ...
  return (
    <Card>
      <CardHeader title='Kelib tushgan shikoyatlar' />
...
export default IncomingComplaintsList
