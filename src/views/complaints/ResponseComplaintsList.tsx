...
const ResponseComplaintsList = ({ invoiceData }: { invoiceData?: InvoiceType[] }) => {
  // States
  ...
  const columns = useMemo<ColumnDef<InvoiceTypeWithAction, any>[]>(
    () => [
      ...
      columnHelper.accessor('address', {
        header: () => <Typography className='w-72'>Shikoyat xati mazmumi</Typography>,
        cell: () => (
      ...
      columnHelper.accessor('companyEmail', {
        header: () => <Typography>Ko`rilgan chora tadbir</Typography>,
        cell: () => <Typography> </Typography>
      }),
      columnHelper.accessor('company', {
        header: 'Javob xati raqami',
        cell: () => (
          <div className='flex items-center gap-3'>
            <div className='flex flex-col'>
              <Typography className='font-medium' color='text.primary'></Typography>
  ...
  return (
    <Card>
      <CardHeader title='Javob xatlari' />
...
export default ResponseComplaintsList
